...
const TVShowCard: React.FC<TVShowCardProps> = ({ show, priority = false }) => {
    ...
    const [imgSrc, setImgSrc] = useState(() => {
        ...
        if (show.backdrop_path_tmdb) {
            return `https://image.tmdb.org/t/p/w300${show.backdrop_path_tmdb}`;
        }
    ...
    // წლის გამოთვლა
    const releaseYear = show.release_date ? new Date(show.release_date).getFullYear() : null;
