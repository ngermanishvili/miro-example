...
export default function ProgrammeSection({ floors, locale }: ProgrammeSectionProps) {
    return (
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {floor.measurements.map((measurement: string, idx: number) => {
                                    ...
                                    const parts = measurement.split(/\s*--\s*|\s*-\s*|\s*–\s*|\s*—\s*/);

                                    if (parts.length > 1) {
                                        return (
                                            <div key={idx} className="text-gray-700 text-sm md:text-base">
